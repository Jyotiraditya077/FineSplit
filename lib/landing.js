...
export const TESTIMONIALS = [
  {
    quote:
      "FineSplit ne meri dosti bachayi yaar! Sab kharche ka exact hisaab, ab tension bilkul zero hai.",
    name: "Rancho",
    image: "/testimonials/rancho.jpg",
    role: "Engineer. Dreamer. Reformer.",
  },
  {
    quote:
      "Parents kehte the photography chhodo, FineSplit ne dosti aur paisa dono ka balance banake rakha.",
    name: "Farhan Qureshi",
    image: "/testimonials/farhan.jpg",
    role: "Wildlife Photographer",
  },
  {
    quote:
      "Main har baar paisa deke bhool jaata tha, FineSplit sab yaad rakhta hai, ab stress bilkul nahi hai.",
    name: "Raju Rastogi",
    image: "/testimonials/raju.jpg",
    role: "Job Seeker & Risk Taker",
  },
];
